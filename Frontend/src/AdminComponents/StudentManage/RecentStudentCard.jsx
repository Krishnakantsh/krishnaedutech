...
const RecentStudentCard = ({width}) => {

  const navigate = useNavigate();

  const handleViewStudent = () => {
    navigate("/api/v2m/p/active_students/:id");
  }
  ...
  return (
    <div className=" flex flex-col shadow-lg  w-full bg-white  rounded-md p-5 h-full"  >
            ...
            <h1 className=" font-semibold text-xl"  >Recent Students</h1>
                      ...
                      </div>
                     {
                      recentStudent?.map((data)=>
                        ...
                        <div className="text-left w-10" >
                          <div className="flex  items-center justify-center  h-8  w-8 rounded-full bg-blue-200 text-blue-500" onClick={handleViewStudent} >
                                <VisibilityIcon fontSize="5px" />
                          </div>
                        </div>
                        <div className="text-left w-10" >
                        <div className="flex  items-center justify-center h-8 w-8 rounded-full bg-green-200 text-green-500" onClick={handleEditStudentDetails}  >
